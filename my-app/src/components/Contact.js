...
import { FaEnvelope, FaPhone, FaTwitter,  } from 'react-icons/fa'; // Importing icons
...
function Contact() {
  ...
  return (
    <div className="contact-container">
      <h3>If you have any questions or inquiries about Hackathon 2024, feel free to get in touch with us. We're here to help!</h3>
